...
pub mod i_access_control_enumerable {
    ...
    impl ::ethers::core::abi::AbiDecode for IAccessControlEnumerableErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IAccessControlEnumerableErrors {
    ...
    impl ::ethers::contract::ContractRevert for IAccessControlEnumerableErrors {
    ...
    impl ::core::fmt::Display for IAccessControlEnumerableErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::AccessControlBadConfirmation(element) => {
    ...
    for IAccessControlEnumerableErrors {
