...
pub mod ownable_2_step {
    ...
    impl<M> ::core::fmt::Debug for Ownable2Step<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(Ownable2Step))
                .field(&self.address())
                .finish()
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for Ownable2StepErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for Ownable2StepErrors {
    ...
    impl ::ethers::contract::ContractRevert for Ownable2StepErrors {
    ...
    impl ::core::fmt::Display for Ownable2StepErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::OwnableInvalidOwner(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for Ownable2StepErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<OwnableInvalidOwner> for Ownable2StepErrors {
        fn from(value: OwnableInvalidOwner) -> Self {
            Self::OwnableInvalidOwner(value)
        }
    }
    impl ::core::convert::From<OwnableUnauthorizedAccount> for Ownable2StepErrors {
