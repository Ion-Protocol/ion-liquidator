...
pub mod access_control_enumerable {
    ...
    impl ::ethers::core::abi::AbiDecode for AccessControlEnumerableErrors {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for AccessControlEnumerableErrors {
    ...
    impl ::ethers::contract::ContractRevert for AccessControlEnumerableErrors {
    ...
    impl ::core::fmt::Display for AccessControlEnumerableErrors {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::AccessControlBadConfirmation(element) => {
    ...
    impl ::core::convert::From<::std::string::String> for AccessControlEnumerableErrors {
        fn from(value: String) -> Self {
            Self::RevertString(value)
        }
    }
    impl ::core::convert::From<AccessControlBadConfirmation>
    for AccessControlEnumerableErrors {
