...
pub mod i_st_eth {
    ...
    impl<M: ::ethers::providers::Middleware> IStEth<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IStEthEvents> {
    ...
    impl ::core::fmt::Display for IStEthEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for IStEthEvents {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for IStEthEvents {
    ...
    impl ::core::convert::From<AllowanceCall> for IStEthCalls {
    ...
    impl ::core::convert::From<TotalSupplyCall> for IStEthCalls {
