...
pub mod liquidator_fork_shared_setup {
    ...
    fn __abi() -> ::ethers::core::abi::Abi {
        ::ethers::core::abi::ethabi::Contract {
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ::std::borrow::ToOwned::to_owned("WstEthDepositFailed"),
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned(
                                "WstEthDepositFailed",
    ...
    ///Custom Error type `WstEthDepositFailed` with signature `WstEthDepositFailed()` and selector `0xda224264`
    #[derive(
        Clone,
        ::ethers::contract::EthError,
        ::ethers::contract::EthDisplay,
    ...
    #[etherror(name = "WstEthDepositFailed", abi = "WstEthDepositFailed()")]
    pub struct WstEthDepositFailed;
    ...
    pub enum LiquidatorForkSharedSetupErrors {
        ...
        WstEthDepositFailed(WstEthDepositFailed),
    ...
    impl ::ethers::core::abi::AbiDecode for LiquidatorForkSharedSetupErrors {
        fn decode(
            ...
            if let Ok(decoded) = <WstEthDepositFailed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::WstEthDepositFailed(decoded));
            }
    ...
    impl ::ethers::core::abi::AbiEncode for LiquidatorForkSharedSetupErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::WstEthDepositFailed(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::ethers::contract::ContractRevert for LiquidatorForkSharedSetupErrors {
        fn valid_selector(selector: [u8; 4]) -> bool {
            match selector {
                ...
                _ if selector
                    == <WstEthDepositFailed as ::ethers::contract::EthError>::selector() => {
                    true
                }
                _ => false,
            }
    ...
    impl ::core::convert::From<WstEthDepositFailed> for LiquidatorForkSharedSetupErrors {
        fn from(value: WstEthDepositFailed) -> Self {
            Self::WstEthDepositFailed(value)
        }
    }
    #[derive(
        Clone,
